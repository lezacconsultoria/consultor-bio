...
const Success: React.FC = () => {
  ...
  return (
    <div className="bg-background-light dark:bg-background-dark min-h-[90vh] flex items-center justify-center py-10 px-6">
      <div className="max-w-[800px] w-full mx-auto">
        <div className="mb-8 flex items-center justify-center gap-3 text-emerald-500 bg-emerald-50 dark:bg-emerald-950/30 w-fit mx-auto px-5 py-2 rounded-full border border-emerald-100 dark:border-emerald-900/50">
        ...
        <div className="text-center space-y-4 mb-10">
          <h1 className="text-brand-dark dark:text-white text-2xl md:text-5xl font-black leading-[1.1] tracking-tighter">
            Gracias por su confianza. <br className="hidden md:block" /> Ahora, quiero invitarlo a dar un paso más allá.
          </h1>
          <p className="text-slate-400 text-lg font-medium leading-relaxed max-w-[600px] mx-auto">
            Donde comparto claridad, no más ruido. Me gustaría que sea parte.
          </p>
        </div>

        <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] py-8 px-6 md:p-10 border border-slate-100 dark:border-slate-800 shadow-xl mb-10 relative overflow-hidden group">
        ...
        <div className="flex flex-col items-center gap-6">
          <a
            ...
            className="group relative inline-flex w-full max-w-[480px] items-center justify-center gap-4 bg-emerald-500 hover:bg-emerald-600 transition-all text-white py-5 px-8 rounded-[2rem] text-xl font-black tracking-tight shadow-2xl shadow-emerald-200 dark:shadow-emerald-950/20 active:scale-95"
          >
            <svg className="size-6 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="uppercase tracking-widest text-base">Unirme a la Comunidad B2B</span>
          </a>
